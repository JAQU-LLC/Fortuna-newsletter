...
export default function AdminDashboard() {
  ...
  const [planConfig, setPlanConfigState] =
    useState<PlanConfig>(getPlanConfig());
  ...
  const handleDisabledPlansChange = (planId: PlanId, disabled: boolean) => {
    ...
    const mostPopular =
      disabled && planConfig.mostPopular === planId
        ? null
    ...
    <div className="min-h-screen bg-muted/30">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <div
              ...
              data-testid="text-total-subscribers"
            >
              {subscribers.length}
            </div>
          </div>
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <div
              className="text-3xl font-display font-bold text-green-600"
              data-testid="text-active-subscribers"
            >
              {activeCount}
            </div>
          </div>
        ...
        <Tabs defaultValue="write" className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="text"
                    placeholder={t(
                      "admin.dashboard.writePost.placeholders.title"
                    )}
                    value={postTitle}
                ...
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    className="[&_.w-md-editor]:rounded-xl [&_.w-md-editor-text]:min-h-[300px]"
                  >
                    <MDEditor
                      value={postContent}
                      ...
                      textareaProps={{
                        placeholder: t(
                          "admin.dashboard.writePost.placeholders.content"
                        ),
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t("admin.dashboard.writePost.markdownHint", {
                      defaultValue:
                        "You can use Markdown formatting. Click the eye icon to preview.",
                    })}
                  </p>
                </div>
                <Button
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="relative w-80">
                  ...
                  <Input
                    type="search"
                    placeholder={t(
                      "admin.dashboard.subscribers.searchPlaceholder"
                    )}
                    value={searchQuery}
                    ...
                    {filteredSubscribers.map((subscriber) => (
                      ...
                      >
                        ...
                        <td
                          ...
                          data-testid={`text-email-${subscriber._id}`}
                        >
                          {subscriber.email}
                        </td>
                        ...
                        <td className="px-6 py-4">
                          ...
                          >
                            {subscriber.is_active
                              ? t("admin.dashboard.subscribers.status.active")
                              : t(
                                  "admin.dashboard.subscribers.status.inactive"
                                )}
                          </span>
                        </td>
                        <td className="px-6 py-4 text-right">
                          <Button
                            variant={
                              subscriber.is_active ? "destructive" : "default"
                            }
                            size="sm"
                            onClick={() =>
                              handleToggleSubscriber(subscriber._id)
                            }
                          ...
                          >
                            {subscriber.is_active ? (
                              <>
                                ...
                                {t(
                                  "admin.dashboard.subscribers.actions.deactivate"
                                )}
                              </>
                            ) : (
                              <>
                                ...
                                {t(
                                  "admin.dashboard.subscribers.actions.activate"
                                )}
                              </>
                            )}
                          </Button>
          ...
          <TabsContent value="posts" className="mt-6">
            <div className="bg-card rounded-xl border border-border p-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-display text-xl font-semibold">
                  {t("admin.dashboard.posts.title", {
                    defaultValue: "Manage Posts",
                  })}
                </h2>
                <div className="relative w-80">
                  <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                  <Input
                    type="search"
                    placeholder={t("admin.dashboard.posts.searchPlaceholder", {
                      defaultValue: "Search posts by title...",
                    })}
              ...
              <div className="overflow-hidden rounded-xl border border-border">
                <table className="w-full">
                  <thead className="bg-muted/50">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-semibold">
                        {t("admin.dashboard.posts.table.title", {
                          defaultValue: "Title",
                        })}
                      </th>
                      <th className="text-left px-6 py-4 text-sm font-semibold">
                        {t("admin.dashboard.posts.table.created", {
                          defaultValue: "Created",
                        })}
                      </th>
                      <th className="text-left px-6 py-4 text-sm font-semibold">
                        {t("admin.dashboard.posts.table.status", {
                          defaultValue: "Status",
                        })}
                      </th>
                      <th className="text-right px-6 py-4 text-sm font-semibold">
                        {t("admin.dashboard.posts.table.actions", {
                      ...
                      filteredPosts.map((post) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            ...
                            >
                              {post.published
                                ? t("admin.dashboard.posts.status.published", {
                                    defaultValue: "Published",
                                  })
                                : t("admin.dashboard.posts.status.draft", {
                                    defaultValue: "Draft",
                                  })}
                            </Badge>
                          </td>
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end gap-2">
                              ...
                              >
                                ...
                                {t("admin.dashboard.posts.actions.edit", {
                                  defaultValue: "Edit",
                                })}
                              </Button>
                              <Button
                              ...
                              >
                                ...
                                {t("admin.dashboard.posts.actions.delete", {
                                  defaultValue: "Delete",
                                })}
                              </Button>
                            </div>
                ...
                {!postsLoading && filteredPosts.length === 0 && (
                  <div className="text-center py-12 text-muted-foreground">
                    {t("admin.dashboard.posts.noResults", {
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) =>
                      handleMostPopularChange(
                        value === "none" ? null : (value as PlanId)
                      )
                    }
                    className="space-y-3"
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label
                        htmlFor="popular-none"
                        className="font-normal cursor-pointer"
                      >
                        None
                      </Label>
                    </div>
                    {(["free", "standard", "premium"] as PlanId[]).map(
                      (planId) => {
                        const isDisabled =
                          planConfig.disabledPlans.includes(planId);
                        return (
                          <div
                            key={planId}
                      ...
                      (planId) => {
                        ...
                        return (
                          ...
                          >
                            <Checkbox
                              id={`disabled-${planId}`}
                              checked={planConfig.disabledPlans.includes(
                                planId
                              )}
                              onCheckedChange={(checked) =>
                                handleDisabledPlansChange(
                                  planId,
                                  checked === true
                                )
                              }
      ...
      >
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {t("admin.dashboard.editPost.title", {
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="edit-published" className="text-sm font-medium">
                {t("admin.dashboard.editPost.published", {
                  defaultValue: "Published",
                })}
              </Label>
            </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("admin.dashboard.posts.delete.confirmTitle", {
          ...
          <AlertDialogFooter>
            ...
            >
              {deletePostMutation.isPending
                ...
                : t("admin.dashboard.posts.delete.confirm", {
                    defaultValue: "Delete",
                  })}
            </AlertDialogAction>
          </AlertDialogFooter>
